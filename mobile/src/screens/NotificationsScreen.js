...
export default function NotificationsScreen({ navigation }) {
	...
	const { notifications, pagination, unreadCount, loading } = useSelector((state) => state.notifications);
	...
	const onRefresh = useCallback(() => {
		setRefreshing(true);
		dispatch(fetchNotifications({ page: 1 })).finally(() => setRefreshing(false));
	}, []);
	...
	return (
		<View style={styles.container}>
			...
			<FlatList
				...
				ListFooterComponent={
					loading ? <ActivityIndicator style={styles.footer} size="small" color="#F97316" /> : null
				}
				refreshControl={
					<RefreshControl

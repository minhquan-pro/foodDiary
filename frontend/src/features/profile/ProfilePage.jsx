...
import { FiEdit2, FiCamera, FiGrid, FiUserPlus, FiUserCheck, FiCheck, FiX } from "react-icons/fi";
...
export default function ProfilePage() {
	...
	const { user: profile, posts, pagination, isFollowing, loading } = useSelector((state) => state.profile);
